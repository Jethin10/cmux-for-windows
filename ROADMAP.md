...
- Pane/surface model. Started with core pane/split layout helpers, backend-owned persisted layout state, typed IPC, focus-neutral reorder/close controls, and tests.
